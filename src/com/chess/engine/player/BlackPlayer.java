...
import com.chess.engine.boards.Move.KingSideCastleMove;
import com.chess.engine.boards.Move.QueenSideCastleMove;
...
public class BlackPlayer extends Player{
    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals, final Collection<Move> opponentsLegals) {
        ...
        if(this.board.getTile(2).isTileOccupied() && this.board.getTile(3).isTileOccupied() && this.board.getTile(1).isTileOccupied()){
